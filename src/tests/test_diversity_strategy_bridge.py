"""
Integration test for diversity sampling through the R bridge.
"""
...
def main() -> None:
    """Run one breeding cycle using diversity sampling."""
    ...
    print(
        "\nDiversity baseline completed one breeding cycle."
    )
    ...
    print(
        "\nAll diversity-strategy bridge checks passed."
    )
